...
def main():
    ...
    categorized_keywords = {
        ...
        "バイオメカニクス・生体工学": {
            ...
            "専門・詳細": ["生体機械", "聴覚・音声メカニズム", "アクティブマター・自己駆動粒子", "血流・血管の解析", "人工心臓・人工弁", "内視鏡", "がん細胞", "嚥下(えんげ)音解析", "血栓解析"]
        },
        "医療福祉・人間工学": {
        ...
        "実験設備・ツール・その他": {
            "主要": ["3Dプリンタ", "設計"],
            "専門・詳細": ["実験装置設計", "VR音響評価", "ハイスピードカメラ", "電子顕微鏡", "マイクロスコープ", "真空装置", "着磁", "三次元計測", "フォトリソグラフィー", "電気化学", "小型燃料電池", "ROS", "Fusion", "Mac", "Claude", "Notion", "快適性評価(well-being)", "プラント安全設計"]
        }
    }
