...
def main():
    ...
    "流体・熱": ["流体", "低Re数", "無次元化", "層流", "表面張力", "マランゴニ対流", "沸騰現象", "気液混相流", "伝熱", "エネルギー効率", "マイクロ流路", "濡れ現象", "乱流", "流体力学", "熱流体", "ナビエ・ストークス方程式", "流れの遷移", "粘弾性流体", "熱交換器", "境界層", "複雑な流れ現象", "高レイノルズ数流れ", "亜音速"],
    "航空宇宙・推進システム": ["スペースプレーン", "極超音速エンジン", "ターボジェットエンジン", "複合サイクルエンジン", "エンジン制御", "エンジン設計", "流路切替機構設計", "航空機設計", "離陸飛行実験", "風洞実験", "航空機翼", "翼の空力設計", "翼の最適化設計"],
    "材料・構造": ["複合材料", "CFRP", "GFRP", "セラミックス", "引張試験", "破壊力学", "DCB試験", "リサイクルCFRP", "フラン樹脂", "衝撃強度試験", "コンプライアンス", "走査電子顕微鏡", "破面観察", "プラズマ照射", "ダイヤモンド", "銅メッキ", "白金触媒", "成膜", "材料力学", "連続体力学", "弾塑性力学", "損傷力学", "材料強度学", "非線形破壊力学", "繰り返し荷重", "溶接", "強度評価", "疲労", "亀裂進展", "J積分"],
    "ロボティクス・制御・機械": ["ロボット", "ロボットアーム", "自動化", "センサ", "ドローン", "人工筋肉", "設計", "モーションキャプチャ", "航空機", "羽ばたき", "マイクロ航空機", "自立飛行", "飛行制御", "ロバスト制御", "電子工作", "ギア", "MEMS", "レーザー加工", "小型ロボットヘリコプター", "流量計開発・評価"],
    "計算工学・データサイエンス": ["CFD解析", "数値解析", "画像解析", "MATLAB", "プログラミング", "フーリエ解析", "人工知能", "機械学習", "有限要素法", "サンプリングモアレ法", "強化学習", "CAE", "IGA", "FPM", "重合メッシュ法", "プログラム実装", "fortran", "c言語", "python", "テンソル解析", "領域積分法", "Simulink", "統計", "marc", "深層学習・CNN", "情報理論・データサイエンス"],
    "バイオ・環境・極限環境": ["生体機械", "バイオメカニクス", "脳波", "介護支援", "内視鏡", "生命維持", "生物模倣", "生体工学", "がん細胞", "宇宙環境", "火星利用", "NASA", "JAXA", "血流・血管の解析", "人工心臓・人工弁", "アクティブマター・自己駆動粒子", "プラントのガス漏洩検知"],
    "実験・設備・その他ツール": ["実験", "実験装置設計", "ハイスピードカメラ", "電子顕微鏡", "真空装置", "着磁", "3Dプリンタ", "Fusion", "理学", "Mac", "リモート", "VR", "共同研究", "Claude", "Notion", "フォトリソグラフィー", "電気化学", "小型燃料電池", "解析手法構築", "水電解"]
    }
