...
def main():
    ...
    categorized_keywords = {
        "熱・流体": [
            "流体", "N-Sの式", "低Re数", "無次元化", "層流", "表面張力", "マランゴニ対流", "沸騰現象", "気液混相流", "伝熱", 
            "エネルギー効率", "低レイノルズ数", "低密度", "風洞", "低真空", "小型燃料電池", "マイクロ流路", "電気化学"
        ],
        "材料・構造": [
            "複合材料", "CFRP", "GFRP", "オートクレープ", "セラミックス", "熱可塑性", "引張試験", "破壊力学", "DCB試験", 
            "リサイクルCFRP", "フラン樹脂", "衝撃強度試験", "コンプライアンス", "走査電子顕微鏡", "破面観察", "プラズマ照射", 
            "ダイヤモンド", "銅メッキ", "白金触媒", "エッチング", "成膜", "材料力学", "連続体力学", "弾塑性力学", "損傷力学", 
            "材料強度学", "非線形破壊力学", "繰り返し荷重", "溶接", "強度評価", "疲労", "亀裂進展", "J積分"
        ],
        "制御・機械・ロボット": [
            "ロボット", "ロボットアーム", "自動化", "センサ（IMU）", "ドローン", "人工筋肉", "設計", "モーションキャプチャ", 
            "航空機", "羽ばたき", "FWMAV", "自立飛行", "飛行制御", "SMC", "ロバスト制御", "電子工作", "ギア", "においセンサー", 
            "MEMS", "レーザー加工"
        ],
        "生体・医療": [
            "生体機械", "バイオメカニクス", "脳波", "介護支援", "内視鏡", "ブタの肝臓", "医科歯科大学", "慈恵医大学", "生命維持", 
            "生物模倣", "ハチドリ", "チョウ", "DNA", "血液", "がん細胞"
        ],
        "解析・プログラミング・情報": [
            "ハイスピードカメラ", "画像解析", "MATLAB", "プログラミング", "数値解析", "フーリエ解析", "人工知能", "機械学習", 
            "有限要素法", "サンプリングモアレ法", "強化学習", "Fusion", "MCP", "3Dプリンタ", "Claude", "Notion", "フォトリソグラフィー", 
            "電子顕微鏡", "CAE", "IGA", "FPM", "重合メッシュ法", "marc", "ADVENTURE", "プログラム実装", "fortran", "c言語", 
            "python", "テンソル解析", "領域積分法", "NURBS"
        ],
        "その他・環境・設備": [
            "実験", "宇宙環境", "JAXA", "Mac", "21号館", "3号館", "リモート", "統計", "産総研", "理化学研究所", "VR", "火星", 
            "Ingenuity", "高速度カメラ", "葛飾キャンパス", "信州大", "NASA", "理学", "実験装置多め", "着磁", "新歓マラソン", 
            "真空装置", "水泳大会", "日本溶接協会"
        ]
    }
