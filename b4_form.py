...
def main():
    ...
    # キーワードを関連性の高い順序に整理し，分かりやすい長さに調整
    categorized_keywords = {
        ...
        "材料・構造・固体力学": [
            ...
            "複合材料", "CFRP", "リサイクルCFRP", "GFRP", "VARTM", "セラミックス", "フラン樹脂", "ダイヤモンド", 
        ...
        "設備・実験手法・その他ツール": [
            ...
            "Fusion", "リモート", "Mac", "Claude", "Notion",
            "VR音響評価", "快適性評価(well-being)"
        ]
    }
