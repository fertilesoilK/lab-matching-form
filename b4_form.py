...
def main():
    ...
    categorized_keywords = {
        ...
        "航空・宇宙": {
            "基本・一般": ["航空機", "航空機設計", "宇宙環境", "JAXA", "エンジン設計","羽ばたき飛行"],
            "専門・詳細": ["航空機翼", "翼の空力設計", "翼の最適化設計", "風洞実験", "離陸飛行実験", "ターボジェットエンジン", "極超音速エンジン", "複合サイクルエンジン", "スペースプレーン", "エンジン制御", "流路切替機構設計", "火星利用", "生命維持", "水電解"]
        },
        "材料・構造・固体力学": {
            "基本・一般": ["材料力学", "疲労", "複合材料", "CFRP", "炭素繊維・連続繊維", "セラミックス", "破壊力学", "連続体力学", "弾塑性力学", "損傷力学", "材料強度学", "非線形破壊力学", "強度評価", "計算固体力学", "計算破壊力学"],
        ...
        "ロボティクス・制御・機械要素": {
            "基本・一般": ["振動工学", "音響シミュレーション", "ロボティクス", "ロボット", "産業用ロボット", "ドローン", "自動車への応用", "自動化", "センサ", "ギア"],
            "専門・詳細": ["協働ロボット(UR等)", "ロボットアーム", "ロボットマニピュレーション", "ロボット制御", "人工筋肉", "モーションキャプチャ", "小型ロボットヘリコプター", "マイクロ航空機", "自立飛行", "飛行制御", "ロバスト制御", "設計", "ロボットビジョン", "ビジュアルサーボ", "電子工作", "MEMS", "レーザー加工", "流量計開発・評価", "警告音設計(自転車等)"]
        },
        "解析・シミュレーション・情報": {
        ...
        "生体・医療・バイオメカニクス": {
            "基本・一般": ["医療工学","生体工学", "医療・福祉支援技術", "介護支援", "感性工学", "生物模倣"],
            "専門・詳細": ["バイオメカニクス", "生体機械", "耳鼻咽喉科学", "アクティブマター・自己駆動粒子", "血流・血管の解析", "人工心臓・人工弁", "内視鏡", "がん細胞", "脳波解析(睡眠・音楽)", "嚥下(えんげ)音解析", "聴力評価(DINテスト)", "病院の音環境"]
        },
        "設備・実験手法・その他ツール": {
            "基本・一般": [ "3Dプリンタ", "VR音響評価"],
