...
def main():
    ...
    "流体・熱": ["流体", "低Re数", "無次元化", "層流", "表面張力", "マランゴニ対流", "沸騰現象", "気液混相流", "伝熱", "エネルギー効率", "マイクロ流路","濡れ現象","乱流"],
    "航空宇宙・推進システム": ["スペースプレーン", "極超音速エンジン", "ターボジェットエンジン", "複合サイクルエンジン", "エンジン制御", "エンジン設計", "流路切替機構設計", "航空機設計", "離陸飛行実験", "風洞実験", "航空機翼"],
    ...
    "ロボティクス・制御・機械": ["ロボット", "ロボットアーム", "自動化", "センサ", "ドローン", "人工筋肉", "設計", "モーションキャプチャ", "航空機", "羽ばたき", "マイクロ航空機", "自立飛行", "飛行制御", "ロバスト制御", "電子工作", "ギア", "MEMS", "レーザー加工","小型ロボットヘリコプター"],
    "計算工学・データサイエンス": ["CFD解析", "数値解析", "画像解析", "MATLAB", "プログラミング", "フーリエ解析", "人工知能", "機械学習", "有限要素法", "サンプリングモアレ法", "強化学習", "CAE", "IGA", "FPM", "重合メッシュ法", "プログラム実装", "fortran", "c言語", "python", "テンソル解析", "領域積分法", "Simulink", "統計","marc"],
    "バイオ・環境・極限環境": ["生体機械", "バイオメカニクス", "脳波", "介護支援", "内視鏡", "生命維持", "生物模倣", "生体工学", "がん細胞", "宇宙環境", "火星利用", "NASA", "JAXA"],
