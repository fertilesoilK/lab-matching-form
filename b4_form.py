...
def main():
    ...
    categorized_keywords = {
        "熱・流体": ["流体", "低Re数", "無次元化", "層流", "表面張力", "マランゴニ対流", "沸騰現象", "気液混相流", "伝熱", "エネルギー効率", "風洞実験", "低真空", "小型燃料電池", "マイクロ流路", "電気化学", "スペースプレーン", "極超音速エンジン", "ターボジェットエンジン", "複合サイクルエンジン", "エンジン制御", "流路切替機構設計", "航空機設計", "離陸飛行実験", "CFD解析"],
