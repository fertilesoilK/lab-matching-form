...
PREDEFINED_KEYWORDS = {
    "流体・熱・エネルギー": {
        "基本・一般": ["流体力学", "流体", "熱流体", "伝熱", "沸騰現象", "熱交換器", "エネルギー効率"],
        "専門・詳細": ["ナビエ・ストークス方程式", "無次元化", "層流", "乱流", "低Re数", "高レイノルズ数流れ", "流れの遷移", "複雑な流れ現象", "亜音速", "粘弾性流体", "境界層", "気液混相流", "表面張力", "濡れ現象", "マランゴニ対流", "マイクロ流路", "プラントのガス漏洩検知", "拡散源推定"]
    },
    "航空・宇宙": {
        "基本・一般": ["航空機", "航空機設計", "宇宙環境", "NASA", "JAXA", "エンジン設計"],
        "専門・詳細": ["航空機翼", "翼の空力設計", "翼の最適化設計", "風洞実験", "離陸飛行実験", "ターボジェットエンジン", "極超音速エンジン", "複合サイクルエンジン", "スペースプレーン", "エンジン制御", "流路切替機構設計", "火星利用", "生命維持", "水電解"]
    },
    "材料・構造・固体力学": {
        "基本・一般": ["材料力学", "疲労", "複合材料", "CFRP", "炭素繊維・連続繊維", "セラミックス", "ダイヤモンド", "溶接"],
        "専門・詳細": ["連続体力学", "弾塑性力学", "損傷力学", "材料強度学", "破壊力学", "非線形破壊力学", "強度評価", "繰り返し荷重", "亀裂進展", "J積分", "コンプライアンス", "引張試験", "曲げ試験", "衝撃強度試験", "DCB試験", "破面観察", "走査電子顕微鏡", "知的材料・構造", "リサイクルCFRP", "GFRP", "VARTM", "フラン樹脂", "成膜", "銅メッキ", "白金触媒", "プラズマ照射"]
    },
    "ロボティクス・制御・機械要素": {
        "基本・一般": ["ロボティクス", "ロボット", "産業用ロボット", "ドローン", "自動車への応用", "自動化", "センサ", "ギア"],
        "専門・詳細": ["協働ロボット(UR等)", "ロボットアーム", "ロボットマニピュレーション", "ロボット制御", "人工筋肉", "モーションキャプチャ", "小型ロボットヘリコプター", "マイクロ航空機", "羽ばたき", "自立飛行", "飛行制御", "ロバスト制御", "設計", "ロボットビジョン", "ビジュアルサーボ", "電子工作", "MEMS", "レーザー加工", "流量計開発・評価", "振動工学", "音響工学", "警告音設計(自転車等)"]
    },
    "解析・シミュレーション・情報": {
        "基本・一般": ["プログラミング", "人工知能", "機械学習", "画像解析", "python", "c言語"],
        "専門・詳細": ["数値解析", "CFD解析", "CAE", "分子シミュレーション", "有限要素法", "IGA", "FPM", "重合メッシュ法", "領域積分法", "サンプリングモアレ法", "marc", "解析手法構築", "フーリエ解析", "テンソル解析", "統計解析", "情報理論・データサイエンス", "最適化", "フィジカルAI", "深層学習・CNN", "強化学習", "画像処理・物体認識", "点群処理", "プログラム実装", "fortran", "MATLAB", "Simulink", "サウンドスケープ評価"]
    },
    "生体・医療・バイオメカニクス": {
        "基本・一般": ["生体工学", "医療・福祉支援技術", "介護支援", "人工心臓・人工弁", "内視鏡", "がん細胞"],
        "専門・詳細": ["バイオメカニクス", "生体機械", "生物模倣", "アクティブマター・自己駆動粒子", "血流・血管の解析", "脳波解析(睡眠・音楽)", "嚥下(えんげ)音解析", "聴力評価(DINテスト)", "病院の音環境"]
    },
    "設備・実験手法・その他ツール": {
        "基本・一般": ["実験", "共同研究", "3Dプリンタ", "VR音響評価"],
        "専門・詳細": ["実験装置設計", "理学", "ハイスピードカメラ", "電子顕微鏡", "マイクロスコープ", "真空装置", "着磁", "三次元計測", "フォトリソグラフィー", "電気化学", "小型燃料電池", "ROS", "Fusion", "リモート", "Mac", "Claude", "Notion", "快適性評価(well-being)", "プラント安全設計"]
    }
}
